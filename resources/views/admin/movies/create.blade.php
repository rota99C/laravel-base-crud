...
<form action="{{route('admin.movies.store')}}" method="post">
    ...
    <div class="mb-4 ms-4 me-4">
        ...
        <input value="{{old('title')}}" class="form-control @error('title') is-invalid @enderror mb-4" type="text" name="title" id="title" placeholder="Insert here the title of the movie" aria-describedby="helpId">
        @error('title')
        ...
        <textarea class="form-control @error('title') is-invalid @enderror" type="text" name="description" id="description" placeholder="Insert here the description of the movie" aria-describedby="helpId">{{old('description')}}</textarea>
        ...
        <input value="{{old('year')}}" class="form-control @error('year') is-invalid @enderror mb-4" type="text" name="year" id="year" aria-describedby="helpId">
        @error('year')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        ...
        <input value="{{old('website_page')}}" class="form-control @error('website_page') is-invalid @enderror mb-4" type="text" name="website_page" id="website_page" placeholder="" aria-describedby="helpId">
        @error('website_page')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        ...
        <input value="{{old('cast')}}" class="form-control @error('cast') is-invalid @enderror mb-4" type="text" name="cast" id="cast" placeholder="" aria-describedby="helpId">
        @error('cast')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        ...
        <input value="{{old('directors')}}" class="form-control @error('directors') is-invalid @enderror mb-4" type="text" name="directors" id="directors" placeholder="" aria-describedby="helpId">
        @error('directors')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        ...
        <input value="{{old('producers')}}" class="form-control @error('producers') is-invalid @enderror mb-4" type="text" name="producers" id="producers" placeholder="" aria-describedby="helpId">
        @error('producers')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        ...
        <input value="{{old('writers')}}" class="form-control @error('writers') is-invalid @enderror mb-4" type="text" name="writers" id="writers" placeholder="" aria-describedby="helpId">
        @error('writers')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        ...
        <input value="{{old('genres')}}" class="form-control @error('genres') is-invalid @enderror mb-4" type="text" name="genres" id="genres" placeholder="Insert here the genres Movie" aria-describedby="helpId">
        @error('genres')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
